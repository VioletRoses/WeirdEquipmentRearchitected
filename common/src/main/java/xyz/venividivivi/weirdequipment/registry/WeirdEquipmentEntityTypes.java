...
public class WeirdEquipmentEntityTypes {
    ...
    public static final RegistrySupplier<EntityType<BlockCannonShotEntity>> BLOCK_CANNON_SHOT = ENTITYTYPES.register("block_cannon_shot", () ->
            new EntityType<BlockCannonShotEntity>(BlockCannonShotEntity::new, SpawnGroup.MISC, false, false, true, false, ImmutableSet.<Block>builder().build(), EntityDimensions.fixed(0.6f, 0.6f), 1000000, 1, FeatureSet.empty()));
